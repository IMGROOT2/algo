  ...
  <main>
    ...
    >
      <div class="hidden sm:mb-8 sm:flex sm:justify-center">
        <div
          class="relative rounded-full px-3 py-1 text-sm leading-6 ring-1 text-white bg-slate-800 m-1 hover:ring-blue-500"
        >
          0.4.0: Statistics update, Search, view individual problems, and more!
          <a
            href="https://github.com/IMGROOT2/algo/releases/tag/v0.4.0"
            target="_blank"
      ...
      <div class="mx-auto max-w-2xl mt-12">
        <div class="hidden lg:block mx-auto">
          <h1 class="text-6xl landing-title text-center dark:text-white text-gray-800 font-bold">
            ...
            >
            from
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-slate-500 to-gray-700"
              >Bronze</span
            >
            <br />
            to
          ...
          <div class="mx-auto flex max-w-xs flex-col gap-y-4">
            ...
            <dd class="order-first text-6xl font-semibold tracking-tight">
              <span
                id="users"
                style="
                  background: -webkit-linear-gradient(#3072d6, #27c877);
...
onMounted(() => {
  ...
  const countriesSpan = document.getElementById('countries')

  usersSpan.innerText = users + '+'
  viewsSpan.innerText = views + '+'
  countriesSpan.innerText = countries + '+'
